...
// Equivalente JS de obtenerFallasGenerales.php
// GET /api/movil/obtener-fallas-generales
router.get("/obtener-fallas-generales", AsyncHandler(async (req, res) => {
    const query = `
        SELECT 
            f.id,
            f.descripcion,
    ...
    try {
        ...
        console.error("Error obtenerFallasGenerales:", error);
